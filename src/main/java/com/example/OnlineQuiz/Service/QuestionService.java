...
public class QuestionService {
    ...
    public QuestionDto add(QuestionDto dto) {
        ...
        QuizEntity quiz=quizRepository.findById(dto.getQuizId()).orElseThrow(()->new ResourceNotFoundException("QuestionService","QuizID", dto.getQuizId(), "QUIZ_NOT_FOUND"));
    ...
    public QuestionDto QuestionById(long id) {
        QuestionEntity question=questionRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("QuizService","QuestionID",id,"QUESTION_NOT_FOUND"));
    ...
    public List<QuestionResponseDto> findByQuizId(long id) {
        ...
        List<QuestionEntity> questions = questionRepository.findByQuizId(id).orElseThrow(()->new ResourceNotFoundException("QuizService","QuizID",id,"QUIZ_NOT_FOUND"));
