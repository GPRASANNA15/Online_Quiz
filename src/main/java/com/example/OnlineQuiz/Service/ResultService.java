...
import com.example.OnlineQuiz.Exception.ResourceNotFoundException;
...
public class ResultService {
    ...
    public ResultResponseDto add(ResultDto dto) {
        ...
        List<QuestionEntity> questions=questionRepository.findByQuizId(dto.getQuizId()).orElseThrow(()->new ResourceNotFoundException("ResultService","QuizID",dto.getQuizId(),"QUIZID_NOT_FOUND"));
        ...
        UserEntity user=userRepository.findById(dto.getUserId()).orElseThrow(()->new ResourceNotFoundException("ResultService","UserID", dto.getUserId(), "User Not Found"));
    ...
    public ResultDto ResultById(long id) {
        ResultEntity result=resultRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("ResultService","ResultID",id,"RESULT_NOT_FOUND"));
